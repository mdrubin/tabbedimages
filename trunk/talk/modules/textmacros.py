...
# Subversion Details
# $LastChangedDate: 2005-06-02 08:42:59 +0100 (Thu, 02 Jun 2005) $
...
class TextMacros:
    ...
    def expand_tree(self, tree):
        ...
        for elem in tree:
            if isinstance(elem, list):
                ...
                z = self.expand_tree(elem[1:-1])  # text between + and -, expanded
    ...
    def eval_macro(self, macrotext, spanned_text=""):
        ...
        name, args = parts[0], parts[1:]    # args may be empty
